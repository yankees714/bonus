...
<div id="content">
    ...
    <article id="pagescontent">
        ...
        <div id="pagescontentbody" class="pagescontentbody">
            ...
            <p>Built by Vic Kotecha &rsquo;05, James Baumberger &rsquo;06, Mark Hendrickson &rsquo;07, Seth Glickman &rsquo;10, and Toph Tucker &rsquo;12 in Brunswick, Rome, and Chestnut Hill. Written in PHP (on the CodeIgniter framework) and JavaScript (with jQuery) with a MySQL database running on Apache. To get involved, <a href="mailto:andrew.daniels714@gmail.com">email Andrew</a>.</p>
